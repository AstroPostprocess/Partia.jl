...
@inline function _point_samples_interpolation_kernel!(grids :: NTuple{L, PS}, i :: Int, input :: INPUT, catalog_consice :: InterpolationCatalogConcise{2, N, G, Div, 0}, LBVH :: LinearBVH{2, TF, Vector{TF}}, :: Type{itpGather}) where {N, G, Div, L, TF <: AbstractFloat, PS <: PointSamples{2, TF, Vector{TF}}, INPUT <: AbstractInterpolationInput{2, TF, Vector{TF}}}
    # Get point
    @inbounds begin
        geometry = grids[1]
    ...
    # Interpolation
    itpresult :: Tuple{NTuple{N, TF}, NTuple{G, NTuple{2, TF}}, NTuple{Div, TF}, Tuple{}} = _general_quantity_interpolate_kernel(input, point, ha, LBVH, catalog_consice)
...
@inline function _point_samples_interpolation_kernel!(grids :: NTuple{L, PS}, i :: Int, input :: INPUT, catalog_consice :: InterpolationCatalogConcise{2, N, G, Div, 0}, LBVH :: LinearBVH{2, TF, Vector{TF}}, :: Type{itpScatter}) where {N, G, Div, L, TF <: AbstractFloat, PS <: PointSamples{2, TF, Vector{TF}}, INPUT <: AbstractInterpolationInput{2, TF, Vector{TF}}}
    # Get point
    @inbounds begin
        geometry = grids[1]
    ...
    # Interpolation
    itpresult :: Tuple{NTuple{N, TF}, NTuple{G, NTuple{2, TF}}, NTuple{Div, TF}, Tuple{}} = _general_quantity_interpolate_kernel(input, point, LBVH, catalog_consice)
