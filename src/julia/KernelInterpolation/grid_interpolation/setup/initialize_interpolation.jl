...
#                              input :: InterpolationInput{D,T}, catalog :: InterpolationCatalog{D, N, G, Div, C, L})
...
######################################################################################
function initialize_interpolation( :: CPUComputeBackend, grid_template :: AS, input :: InterpolationInput{D, T}, catalog :: InterpolationCatalog{D, N, G, Div, C, L}) where {D, N, G, Div, C, L, T <: AbstractFloat, AS <: AbstractSamples{D, T}}
