"""
    initialize_interpolation( :: CPUComputeBackend, grid_template :: AbstractSamples{D, T},
                              input :: AbstractInterpolationInput{D, T}, catalog :: InterpolationCatalog{D, N, G, Div, C, L})
...
- `input :: AbstractInterpolationInput{D, T}`
  An interpolation input object containing particle data, smoothing lengths,
  field values, and the SPH kernel used for interpolation.
...
"""
function initialize_interpolation( :: CPUComputeBackend, grid_template :: AS, input :: INPUT, catalog :: InterpolationCatalog{D, N, G, Div, C, L}) where {D, N, G, Div, C, L, T <: AbstractFloat, AS <: AbstractSamples{D, T}, INPUT <: AbstractInterpolationInput{D, T}}
