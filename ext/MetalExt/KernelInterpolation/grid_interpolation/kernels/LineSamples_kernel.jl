@inline function _line_integrated_tables_Mtl()
    ...
    return (
        Q32(Partia.KernelInterpolation._M4_spline_Q32),
        Q32(Partia.KernelInterpolation._M4_spline_Inorm32),
        Q32(Partia.KernelInterpolation._M5_spline_Q32),
        Q32(Partia.KernelInterpolation._M5_spline_Inorm32),
        Q32(Partia.KernelInterpolation._M6_spline_Q32),
        Q32(Partia.KernelInterpolation._M6_spline_Inorm32),
        Q32(Partia.KernelInterpolation._C2_Wendland_Q32),
        Q32(Partia.KernelInterpolation._C2_Wendland_Inorm32),
        Q32(Partia.KernelInterpolation._C4_Wendland_Q32),
        Q32(Partia.KernelInterpolation._C4_Wendland_Inorm32),
        Q32(Partia.KernelInterpolation._C6_Wendland_Q32),
        Q32(Partia.KernelInterpolation._C6_Wendland_Inorm32),
    )
end
...
@inline function _line_integrated_quantities_interpolate_kernel_Mtl(input :: InterpolationInput{3, TF, VF, K, NCOLUMN}, origin :: NTuple{3, TF}, direction :: NTuple{3, TF}, LBVH :: LinearBVH, columns :: NTuple{M, Int}, ShepardNormalization :: NTuple{M, Bool}, tables, :: Type{itpScatter}) where {TF <: Float32, VF <: MtlDeviceVector{TF}, K <: AbstractSPHKernel, NCOLUMN, M}
    ...
    LinearBoundingVolumeHierarchy.@LBVH_scatter_line_traversal LBVH origin direction Kvalid leaf_idx p2leaf_d2 hb begin
        @inbounds begin
            ...
            W = _line_integrated_kernel_function_Mtl(K, r, hb, tables)
            S1b = mb * W / ρb
            S1 += S1b
